...
public  class Activity_3rd_Adapter extends RecyclerView.Adapter<Activity_3rd_Adapter.ViewHolder>{
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view){
            ...
            // text_view_3rd_date=(TextView) view.findViewById(R.id.activity_3rd_date);
            //text_view_3rd_score=(TextView) view.findViewById(R.id.activity_3rd_score);
...
//                });
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //holder.text_view_3rd_date.setText(activity_3rd_class.getDate());
        // holder.text_view_3rd_score.setText("    "+activity_3rd_class.getScore()+"     ");
