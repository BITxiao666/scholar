...
public class Activity_2ed extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //退出当前活动按钮点击事件
//        final Button button_exit = (Button) findViewById(R.id.activity_2ed_eixt);
...
//        Activity_2ed_class activity_2ed_class_2ed=new Activity_2ed_class("2018-01", "10","班长职务");
//        activity_2ed_classList.add(activity_2ed_class_2ed);
//        Activity_2ed_class activity_2ed_class_2st=new Activity_2ed_class("2018-02","5","科协技术部部长");
//        activity_2ed_classList.add(activity_2ed_class_2st);
//        Activity_2ed_class activity_2ed_class_3st=new Activity_2ed_class("2018-01", "8","班长职务");
//        activity_2ed_classList.add(activity_2ed_class_3st);
//        Activity_2ed_class activity_2ed_class_4st=new Activity_2ed_class("2018-02","5","科协技术部部长");
//        activity_2ed_classList.add(activity_2ed_class_4st);
