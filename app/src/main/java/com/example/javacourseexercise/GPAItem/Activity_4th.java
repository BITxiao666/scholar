...
public class Activity_4th extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //退出当前活动按钮点击事件
//        final Button button_exit = (Button) findViewById(R.id.activity_4th_eixt);
...
//        Activity_4th_class activity_4th_class_4th=new Activity_4th_class("2018-01", "10","班长职务");
//        activity_4th_classList.add(activity_4th_class_4th);
//        Activity_4th_class activity_4th_class_2st=new Activity_4th_class("2018-02","5","科协技术部部长");
//        activity_4th_classList.add(activity_4th_class_2st);
//        Activity_4th_class activity_4th_class_3st=new Activity_4th_class("2018-01", "8","班长职务");
//        activity_4th_classList.add(activity_4th_class_3st);
//        Activity_4th_class activity_4th_class_4st=new Activity_4th_class("2018-02","5","科协技术部部长");
//        activity_4th_classList.add(activity_4th_class_4st);
