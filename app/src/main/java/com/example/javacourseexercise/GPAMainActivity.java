...
//        getMenuInflater().inflate(R.menu.menu_gpamain, menu);
//        return true;
//    }
//
//    @Override
...
//        int sum_1st=0;
//        List<Activity_1st_table> Activity_1st_tables= DataSupport.findAll(Activity_1st_table.class);
//        for(Activity_1st_table Activity_1st_table: Activity_1st_tables){
//            String s=Activity_1st_table.getScore();
//            try{
//
